...
<title>Online Site for all your Mobiles </title>
...
<div class="footer">
		...
		<div class="row">
			<div class="col-md-4 col-sm-6 footer-navigation">
			    ...
			    <p class="links"><a href="home.jsp">Home</a><strong> · </strong><a href="#">Terms and Conditions</a><strong> 
			...
			<div class="col-md-4 col-sm-6 footer-contacts">
			    ...
			    <div><span class="fa fa-phone footer-contacts-icon"></span>
			        <p> <span class="new-line-span"></span>1800-123-352</p>
			    </div>
