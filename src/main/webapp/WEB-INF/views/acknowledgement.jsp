        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    <li><a href="http://localhost:8080/Mobilestore/">HOME</a></li>
                    <li><a href="#"></a></li>
	...
	<table class="table table-hover table-condensed">
     <c:if test="${not empty error}">
		...
		<tbody>
			...
			<c:set var="subtot" value="${order.price * order.quantity}"></c:set>
			 <td class="col-sm-1 col-md-1 text-center"><strong><span class="fa fa-inr"></span> ${subtot}</strong></td>			
		</tr>
	
		<c:set var="gtot" value="${gtot + order.price * order.quantity}"></c:set>
		</c:forEach>
		<tr>
			<td>  </td>
			<td>  </td>
